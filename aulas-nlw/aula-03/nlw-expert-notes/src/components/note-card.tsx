        ...
        <Dialog.Root>
            ...
            <Dialog.Portal>
                <Dialog.Overlay className="inset-0 fixed bg-black/50 flex justify-center items-center">
                    <Dialog.DialogContent className="fixed overflow-hidden w-full min-[660px]:max-w-[640px] h-full min-[660px]:h-[60vh] bg-slate-700 min-[660px]:rounded-md flex flex-col outline-none">
                        ...
                        <div className="flex flex-1 flex-col gap-3 p-5">
                            ...
                            <pre className="font-sans text-sm leading-6 text-slate-400">
                                {note.content}
                            </pre>
                        </div>
